  ...
  return (
    ...
    >
      <Head>
        ...
        <link
          rel="canonical"
          href="https://tim.cmaisonneuve.qc.ca/professeurs"
        />
        <meta property="og:title" content="Professeurs | TIM Maisonneuve" />
        <meta
          property="og:url"
          content="https://tim.cmaisonneuve.qc.ca/professeurs"
        />
        <meta
      ...
      <div className={styles.sectionTexte}>
        <Link href="professeurs/grille">
          <motion.h2
            ...
            whileTap={{ scale: 1.05 }}
          >
            PLUS<b>++</b>DE <b>25 ANS</b> D&apos;EXPÉRIENCE DANS LE DOMAINE POUR
            VOUS DONNER <b>LA MEILLEURE ÉDUCATION</b>
          </motion.h2>
        </Link>
      </div>
    </motion.div>
